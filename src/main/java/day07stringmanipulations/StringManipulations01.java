...
public class StringManipulations01 {
    public static void main(String[] args) {
       ...
       String t3 = t.replaceAll("[aeiouAEIOU]","?");
        ...
        //Ornek 5: "t" stringindeki tum harfler dısındakileri "+" ya cevirin

        String t5 = t.replaceAll("[^a-zA-Z]","+");
        System.out.println(t5);//Ali++++yasindadir++++

        //Ornek 6: "t" stringindeki spaceler dısındaki tum karakterleri  "?" ne ceviriniz
        String t6 = t.replaceAll("[^ ]","?");
        System.out.println(t6);//??? ?? ??????????????

        //Ornek 7: "t" stringindeki sesli harfler dısındaki sesli harfleri "&" e ceviriniz
