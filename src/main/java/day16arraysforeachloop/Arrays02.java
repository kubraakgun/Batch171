...
//                             Math(4)                           Art(3)
        ...
        //lenght methodu kelimelerin harf sayisini almaya yarar.
        ...
        for (int i = 0; i < brr.length; i++) {
            totalChar = totalChar + brr[i].length();//30
        }
       ...
       */
        ...
        //Ornek 3: Notlar adinda Integer olusturunuz icine 6 tane not yerlestiriniz ve not ortalamasini
        //ekrana yazdiriniz.
