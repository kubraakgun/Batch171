...
public class Arrays03 {
    public static void main(String[] args) {
        ...
        //Ornek 1: Integer bir array olustunuz, icine 6 tane eleman yerlestiriniz.Bu elemanlarin en kucugu ile en buyugunun toplamini ekrana yazdiriniz
        int ages[] = new int[6];
        ages[0] = 20;
        ages[1] = 23;
        ages[2] = 19;
        ...
        //1. Yol :
        //sort methodu arry deki elemanlari kucukten buyuge dizer
        Arrays.sort(ages);
        ...
        //Ornek 2: String bir array olusturunuz 6 eleman ekleyiniz, yellow dan onceki elemanlari yaziniz
