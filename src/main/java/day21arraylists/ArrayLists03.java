...
public class ArrayLists03 {
    public static void main(String[] args) {
        ...
        //List.of methodu degistirilemez bir list olusturmak icin kullanilir, bu nedenle list uzerinde degisiklik
        //yapmaya yonelik methodlari desteklemez ama diger list methodlarini kullanabiliriz
